const EVENTS_ENUM = {
    ...
    SELECT_FROM_LIBRARY_UPLOAD_DATASET_CLICKED: "SELECT_FROM_LIBRARY_UPLOAD_DATASET_CLICKED",
    ...
    DATASET_UPDATION_SUCCESSFUL: 'DATASET_UPDATE_SUCCESSFUL',
...
const EVENTS_REGISTRY = {
    ...
    SELECT_FROM_LIBRARY_CONTINUE_CLICKED: {
        ...
        parameter: ["total_datasets_shown", "clicked_on", "dataset_id", "dataset_name"]
    },
    ...
    UPLOAD_DATASET_FAILED: {
        ...
        parameter: ["files_count", "files_type", "files_failed_count", "error_desc", "error_code"]
    },
    UPLOAD_MORE_CLICKED: {
    ...
    SAVE_DATASET_CLICKED: {
        ...
        parameter: ["files_count", "files_type", "analysis_chosen", "dataset_name", "is_description_filled"]
    },
    SAVE_DATASET_SUCCESSFUL: {
        trigger: "When dataset is successfully saved",
        parameter: ["files_count", "files_type", "analysis_chosen", "dataset_id", "dataset_name", "is_description_filled", "total_dataset_size"],
    },
    SAVE_DATASET_FAILED: {
        trigger: "When dataset is failed to get saved",
        parameter: ["files_count", "files_type", "total_dataset_size", "error_desc", "error_code"],
    },
    REMOVE_UPLOAD_FILE: {
    ...
    CHAT_SCREEN_LOADED: {
        ...
        parameter: ["dataset_id", "dataset_name", "source", "chat_session_id"], 
    },
    ...
    L2_CATEGORY_CLICKED: {
        ...
        parameters: ["dataset_id", "dataset_name", "l1_category_name", "clicked_on", "total_suggestions"],
    },
    CHAT_SESSION_STARTED: {
        trigger: 'when a new chat session is started',
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "start_method"],
    },
    PLANNER_TAB_CLICKED: {
    ...
    PLANNER_EDITED: {
        ...
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "query_id", "type_change"],
    },
    ...
    REFERENCE_EDITED: {
        ...
        parameters: ["edited_file_names", "chat_session_id", "dataset_id", "dataset_name", "query_id"],
    },
    CODER_TAB_CLICKED: {
    ...
    REGENERATE_RESPONSE_CLICKED: {
        ...
        parameters: ["type_change", "chat_session_id", "dataset_id", "dataset_name", "query_id"],
    },
    ...
    ANALYSIS_GRAPH_VARIANT_CLICKED: {
        ...
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "query_id", "graph_id", "graph_name", "graph_type"],
    },
    TABLE_VIEW_CHANGED: {
        trigger: 'When user tries to change the output table view by sorting',
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "query_id", "change_type"],
    },
    ...
    VIEW_DASHBOARD_CLICKED: {
        trigger: 'When user clicks on view dashboard pop_up after adding to dashboard',
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "query_id", "dashboard_id", "dashboard_name"],
    },
    ...
    FOLLOW_UP_SUGGESTION_SHOWED: { 
        ...
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "query_id", "ques_count"],
    },
    CLICKED_FOLLOW_UP_SUGGESTION: { 
        trigger: 'When user clicks on follow-up suggestion',
        parameters: ["chat_session_id", "dataset_id", "dataset_name", "query_id", "question", "clicked_on"],
    },
    CHAT_MESSAGE_SENT: {
        trigger: "When user or AI sends a message in the chatbox",
        parameters: ["chat_session_id", "query_id", "dataset_id", "dataset_name", "message_type", "message_source", "message_text", "is_clarification", "message_number","first_message_in_chat"] 
    },
    ...
    GRAPH_CARD_CLICKED: { 
        ...
        parameters: ["dashboard_id", "dashboard_name", "query_id", "query_text", "dashboard_content_id"],
    },
    DASHBOARD_GRAPH_VIEW_CHANGED: { 
        trigger: 'When user changes the graph',
        parameters: ["dashboard_id", "dashboard_name", "query_id", "query_text", "graph_id", "graph_title", "graph_type", "dashboard_content_id"],
    },
    ...
    ADDED_ANALYSIS_TO_DASHBOARD: {
        ...
        parameters: ["chat_session_id", 'query_id', 'dataset_id', "dataset_name", "dashboard_id", "dashboard_name", "dashboard_type"]
    },
    ADDED_ANALYSIS_TO_REPORT: {
        trigger: "when user adds analysis to report",
        parameters: ["chat_session_id", 'query_id', 'dataset_id', "dataset_name", "report_name", "report_id"]
    },
    DASHBOARD_SEARCHED: {
    ...
    DATASET_DELETION_FAILED: {
        ...
        parameters: ["source", "dataset_id", "dataset_name", "error_desc", "error_code"],
    },
    ...
    DATASET_COLUMN_DESCRIPTION_UPDATED: {
        ...
        parameters: ["dataset_id", "dataset_name", "file_name", "file_id", "col_name", "old_col_desc", "new_col_desc"],
    },
    ...
    DATASET_GLOSARRY_TERM_EDITED: {
        ...
        parameters: ["dataset_id", "dataset_name", "old_glossary_term", "new_glossary_term"],
    },
    DATASET_GLOSARRY_DESC_EDITED: {
        trigger: "When user tries to update description",
        parameters: ["dataset_id", "dataset_name", "old_glossary_desc", "new_glossary_desc"],
    },
    ...
    DATASET_UPDATION_FAILED: {
        ...
        parameters: ["dataset_id", "dataset_name", "changes", "error_desc", "error_code"],
    },
