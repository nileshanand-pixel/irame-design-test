					...
					<div className="h-full w-full relative">
						<SheetHeader className="p-6 pb-4">
							<SheetTitle className="text-base text-[#26064A] font-semibold">
								{isReadOnly ? 'View' : 'Manage'} Team Members -{' '}
						...
						<div
							className={`h-[calc(100%-9rem)] flex flex-col gap-4 border-t border-gray-300 py-3 overflow-hidden ${isReadOnly ? 'h-[calc(100%-6rem)]' : ''}`}
						>
							{/* Current Members Box */}
							<div
								className={`flex flex-col overflow-hidden px-6 ${isReadOnly ? 'flex-1' : 'flex-1 max-h-[50%]'}`}
							>
