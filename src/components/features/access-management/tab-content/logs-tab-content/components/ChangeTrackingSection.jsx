...
const StateDisplay = ({ state, label }) => {
	...
	return (
		<div>
			...
			<div className="bg-[#F9FAFB] border border-[#E5E7EB] rounded p-3 space-y-2">
...
export default function ChangeTrackingSection({ log }) {
	...
	return (
		<div className="border border-[#E6E2E9] rounded-lg p-4 space-y-3">
			...
			<div className="space-y-3">
				{hasBefore && (
					<StateDisplay state={log.before_state} label="Before" />
				)}
