		...
		<div className="w-full h-full ">
			{filteredApprovals.length === 0 && !search ? (
				...
				<div className="space-y-6 flex flex-col h-full">
					{/* Search Bar - Always visible when in content mode */}
					...
					<div className="flex-1 min-h-0">
						{filteredApprovals.length === 0 ? (
							...
							<div className="border border-[#0000001A] rounded-lg shadow-sm h-full overflow-hidden">
								<div className="px-6 py-4 flex justify-between items-center border-b border-[#0000001A] flex-shrink-0">
