...
const STEPS_DATA = [
    {
        id: 1,
        text: 'Evaluate overall marketing performance across different channels (e.g., social media, email, paid ads, events) focusing on leads generated and cost per lead over the last 12 months.',
    },
    { id: 2, text: 'Identify top-performing channels and adjust budget allocation.' },
    { id: 3, text: 'Optimize campaign performance based on insights.' },
    { id: 4, text: 'Set goals and benchmarks for the next cycle.' },
];
...
const WorkflowPage = () => {
    ...
    return (
        <div className="relative border-3 h-full w-full overflow-y-auto text-primary80">
            <Breadcrumb items={BREADCRUMB_ITEMS(businessProcessId)} navigate={navigate} />
            <div className="w-3/5 h-[90%] overflow-y-auto mx-auto p-4">
                <WorkflowDetails />
                <DataSourceCard />
...
const HeaderWithActions = () => (
    <div className="flex justify-between items-center mb-6 pb-4 border-b-2 border-primary10">
        ...
        <div className="flex space-x-2">
            <Button
                variant="outline"
                onClick={() => alert('implement view history')}
...
// Run Workflow CTA Component
const RunWorkflowCTA = () => (
    <div className="absolute bottom-2 left-1/4 w-1/2">
        <Button
            className="rounded-lg hover:bg-purple-100 h-12 py-1 hover:text-white hover:opacity-80 w-full"
