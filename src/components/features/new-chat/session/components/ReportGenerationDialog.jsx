			...
			<Dialog open={open} onOpenChange={closeModal}>
				<DialogContent className="sm:w-[500px] p-6">
					...
					<Button
						...
						disabled={createSessionReportMutation.isPending || !chatStoreReducer?.queries?.length}
					>
					...
					<div className="flex flex-col gap-4 max-h-[400px] overflow-y-auto">
						{sessionReportsData.isLoading ? (
							...
							<span className='text-center text-primary40 font-semibold text-lg'> No Reports Available</span>
						) : (
