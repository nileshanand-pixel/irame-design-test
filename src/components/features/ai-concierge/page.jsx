...
const AiConciergePage = () => {
	...
	return (
		<div className="h-full w-full flex flex-col px-8">
			...
			<section className="max-w-full flex-1 border border-white/60 mb-4 bg-gradient-to-br from-[rgba(249,245,255,1)] via-[rgba(238,232,248,0.5)] to-[rgba(249,250,251,1)] shadow-1xl rounded-xl overflow-hidden">
